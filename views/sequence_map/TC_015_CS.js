...
export const TC_015_CS_SEQUENCE = [
  {
    step: 1,
  ...
  },
  {
    ...
    evse: "Send StopTransaction.req (reason = HardReset)",
    description: "Verify that StopTransaction.req is received with reason 'HardReset'. Verify that StopTransaction.req contains the same IdTag as StartTransaction.req. Verify that StopTransaction.conf is received with status 'Accepted'. Note: Step 7 and 8 can be in different order."
  },
  {
    step: 8,
    ev: "Send StatusNotification.conf (empty)",
