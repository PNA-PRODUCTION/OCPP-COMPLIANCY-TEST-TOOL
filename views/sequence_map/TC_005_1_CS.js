// TC_005_1_CS: EV Side Disconnected - StopTransactionOnEVSideDisconnect = true - UnlockConnectorOnEVSideDisconnect = true
export const TC_005_1_CS_SEQUENCE = [
  {
    step: 1,
  ...
  },
  {
    ...
    evse: "Send GetConfiguration.conf",
    description: "Send GetConfiguration.req with key 'UnlockConnectorOnEVSideDisconnect'. Verify that GetConfiguration.conf is received and contains UnlockConnectorOnEVSideDisconnect value. If value is not true, send ChangeConfiguration.req to set it to true."
  },
  {
    step: 7,
    ev: "Send ChangeConfiguration.req (UnlockConnectorOnEVSideDisconnect = true)",
    evse: "Send ChangeConfiguration.conf",
    description: "If UnlockConnectorOnEVSideDisconnect was not true, verify that ChangeConfiguration.conf is received with status 'Accepted'."
  },
  {
    step: 8,
